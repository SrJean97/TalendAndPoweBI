...
package costoshospitalaria.dim_accidente_0_1;
...
/**
 * Job: dim_accidente Purpose: dim_accidente<br>
 * Description: Creación dimensión de accidentes <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class dim_accidente implements TalendJob {
	...
	private final String jobName = "dim_accidente";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dim_accidente.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_accidente.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Flts6giqeFQw60j+aBrUt6HESBUmK05Noccj8Gl3/qYFlQ==");
	...
	public static class salida_dim_accidenteStruct
			implements routines.system.IPersistableRow<salida_dim_accidenteStruct> {
		final static byte[] commonByteArrayLock_COSTOSHOSPITALARIA_dim_accidente = new byte[0];
		static byte[] commonByteArray_COSTOSHOSPITALARIA_dim_accidente = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_COSTOSHOSPITALARIA_dim_accidente.length) {
					if (length < 1024 && commonByteArray_COSTOSHOSPITALARIA_dim_accidente.length == 0) {
						commonByteArray_COSTOSHOSPITALARIA_dim_accidente = new byte[1024];
					} else {
						commonByteArray_COSTOSHOSPITALARIA_dim_accidente = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_COSTOSHOSPITALARIA_dim_accidente, 0, length);
				strReturn = new String(commonByteArray_COSTOSHOSPITALARIA_dim_accidente, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_COSTOSHOSPITALARIA_dim_accidente, 0, length);
				strReturn = new String(commonByteArray_COSTOSHOSPITALARIA_dim_accidente, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_COSTOSHOSPITALARIA_dim_accidente) {
		 ...
		 * Compare keys
		 */
		public int compareTo(salida_dim_accidenteStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				salida_dim_accidenteStruct salida_dim_accidente = new salida_dim_accidenteStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "salida_dim_accidente");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:PhPW/n/7fiIikTSSvWLIvSoHmb2xbxqFEugUQU6n33IWQA==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("dim_accidente");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("dim_accidente");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (RELACION_USUARIO_ACCIDENTE,FECHA_DE_ACCIDENTE,HORA_DE_ACCIDENTE,MES,ANO,DIA_SEMANA,TIPO_DE_VEHICULO) VALUES (?,?,?,?,?,?,?)";
...
// # Outputs initialization
				salida_dim_accidenteStruct salida_dim_accidente_tmp = new salida_dim_accidenteStruct();
// ###############################
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								salida_dim_accidente = null;

// # Output table : 'salida_dim_accidente'
								salida_dim_accidente_tmp.RELACION_USUARIO_ACCIDENTE = row1.RELACION_USUARIO_ACCIDENTE;
								salida_dim_accidente_tmp.FECHA_DE_ACCIDENTE = Tratamiento_de_datos
										.transformacion_fecha(row1.FECHA_DE_ACCIDENTE);
								salida_dim_accidente_tmp.HORA_DE_ACCIDENTE = (row1.HORA_DE_ACCIDENTE.length() == 0)
										? "SIN INFORMACIÓN"
										: Tratamiento_de_datos.transformacion_hora(row1.HORA_DE_ACCIDENTE);
								salida_dim_accidente_tmp.MES = row1.MES;
								salida_dim_accidente_tmp.ANO = row1.ANO;
								salida_dim_accidente_tmp.DIA_SEMANA = row1.DIA_SEMANA;
								salida_dim_accidente_tmp.TIPO_DE_VEHICULO = row1.TIPO_DE_VEHICULO;
								salida_dim_accidente = salida_dim_accidente_tmp;
// ###############################
							 ...
							 */
// Start of branch "salida_dim_accidente"
							if (salida_dim_accidente != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1
											...
											, "salida_dim_accidente"

									);
								}

								whetherReject_tDBOutput_1 = false;
								if (salida_dim_accidente.RELACION_USUARIO_ACCIDENTE == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, salida_dim_accidente.RELACION_USUARIO_ACCIDENTE);
								}

								if (salida_dim_accidente.FECHA_DE_ACCIDENTE != null) {
									pstmt_tDBOutput_1.setTimestamp(2,
											new java.sql.Timestamp(salida_dim_accidente.FECHA_DE_ACCIDENTE.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.DATE);
								}

								if (salida_dim_accidente.HORA_DE_ACCIDENTE == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, salida_dim_accidente.HORA_DE_ACCIDENTE);
								}

								if (salida_dim_accidente.MES == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, salida_dim_accidente.MES);
								}

								if (salida_dim_accidente.ANO == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, salida_dim_accidente.ANO);
								}

								if (salida_dim_accidente.DIA_SEMANA == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, salida_dim_accidente.DIA_SEMANA);
								}

								if (salida_dim_accidente.TIPO_DE_VEHICULO == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, salida_dim_accidente.TIPO_DE_VEHICULO);
								}
							...
							} // End of branch "salida_dim_accidente"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "salida_dim_accidente");
				}
	...
	public static void main(String[] args) {
		final dim_accidente dim_accidenteClass = new dim_accidente();

		int exitCode = dim_accidenteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_accidente.class.getClassLoader()
					.getResourceAsStream("costoshospitalaria/dim_accidente_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_accidente.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_accidente");
		}
...
/************************************************************************************************
 * 113003 characters generated by Talend Open Studio for Data Integration on the
 * 27 de junio de 2022, 16:31:15 COT
 ************************************************************************************************/