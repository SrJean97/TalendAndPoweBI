		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oaQFBnSJTS/FXMFWIDkUK74/uUZbhdkXz4QCBC+7vNzBgg==");
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "RELACION_USUARIO_ACCIDENTE", "FECHA_DE_ACCIDENTE",
						"HORA_DE_ACCIDENTE", "MES", "ANO", "DIA_SEMANA", "TIPO_DE_VEHICULO", });
...
// # Output table : 'salida_dim_accidente'
								...
								salida_dim_accidente_tmp.FECHA_DE_ACCIDENTE = (row1.FECHA_DE_ACCIDENTE.length() == 0)
...
///////////////////////		
								...
								if (salida_dim_accidente.RELACION_USUARIO_ACCIDENTE != null) { //
									row_tLogRow_1[0] = String.valueOf(salida_dim_accidente.RELACION_USUARIO_ACCIDENTE);

								} //

								if (salida_dim_accidente.FECHA_DE_ACCIDENTE != null) { //
									row_tLogRow_1[1] = FormatterUtils
											.format_Date(salida_dim_accidente.FECHA_DE_ACCIDENTE, "dd-MM-yyyy");

								} //

								if (salida_dim_accidente.HORA_DE_ACCIDENTE != null) { //
									row_tLogRow_1[2] = String.valueOf(salida_dim_accidente.HORA_DE_ACCIDENTE);

								} //

								if (salida_dim_accidente.MES != null) { //
									row_tLogRow_1[3] = String.valueOf(salida_dim_accidente.MES);

								} //

								if (salida_dim_accidente.ANO != null) { //
									row_tLogRow_1[4] = String.valueOf(salida_dim_accidente.ANO);

								} //

								if (salida_dim_accidente.DIA_SEMANA != null) { //
									row_tLogRow_1[5] = String.valueOf(salida_dim_accidente.DIA_SEMANA);

								} //

								if (salida_dim_accidente.TIPO_DE_VEHICULO != null) { //
									row_tLogRow_1[6] = String.valueOf(salida_dim_accidente.TIPO_DE_VEHICULO);
...
/************************************************************************************************
 * 110592 characters generated by Talend Open Studio for Data Integration on the
 * 29 de junio de 2022, 12:22:58 COT
 ************************************************************************************************/