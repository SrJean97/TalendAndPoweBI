...
package costoshospitalaria.dim_atencion_medica_0_1;
...
/**
 * Job: dim_atencion_medica Purpose: dim_atencion_medica<br>
 * Description: dim_atencion_medica <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class dim_atencion_medica implements TalendJob {
	...
	private final String jobName = "dim_atencion_medica";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dim_atencion_medica.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_atencion_medica.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:E9hJodH1xTaYqJi0nYgl9mWdc1OeKbrCQNzveFyPUYQvvA==");
	...
	public static class atencion_medicaStruct implements routines.system.IPersistableRow<atencion_medicaStruct> {
		final static byte[] commonByteArrayLock_COSTOSHOSPITALARIA_dim_atencion_medica = new byte[0];
		static byte[] commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica = new byte[0];

		public java.util.Date FECHA_DE_INGRESO_IPS;

		public java.util.Date getFECHA_DE_INGRESO_IPS() {
		...
		public java.util.Date FECHA_DE__ATENCION_MEDICA;

		public java.util.Date getFECHA_DE__ATENCION_MEDICA() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica.length) {
					if (length < 1024 && commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica.length == 0) {
						commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica = new byte[1024];
					} else {
						commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica, 0, length);
				strReturn = new String(commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica, 0, length);
				strReturn = new String(commonByteArray_COSTOSHOSPITALARIA_dim_atencion_medica, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_COSTOSHOSPITALARIA_dim_atencion_medica) {

				try {

					int length = 0;

					this.FECHA_DE_INGRESO_IPS = readDate(dis);

					this.HORA_DE_INGRESO_IPS = readString(dis);

					this.FECHA_DE__ATENCION_MEDICA = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeDate(this.FECHA_DE_INGRESO_IPS, dos);
				...
				writeDate(this.FECHA_DE__ATENCION_MEDICA, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("FECHA_DE_INGRESO_IPS=" + String.valueOf(FECHA_DE_INGRESO_IPS));
			sb.append(",HORA_DE_INGRESO_IPS=" + HORA_DE_INGRESO_IPS);
			sb.append(",FECHA_DE__ATENCION_MEDICA=" + String.valueOf(FECHA_DE__ATENCION_MEDICA));
		 ...
		 * Compare keys
		 */
		public int compareTo(atencion_medicaStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				atencion_medicaStruct atencion_medica = new atencion_medicaStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "atencion_medica");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oJZuzArKiCzwLw9lNs2ja6Py4YDoiz9pGCRmjzQFLX5whA==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("dim_atencion_medica");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("dim_atencion_medica");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (FECHA_DE_INGRESO_IPS,HORA_DE_INGRESO_IPS,FECHA_DE__ATENCION_MEDICA,HORA_DE_ATENCION_MEDICA,REQUERIMIENTO_DE_CX,REFERIDO_A_OTRA_IPS,REGION_ANATOMICA_MAS_AFECTADA,POLITRAUMATISMO,CONDICION_EGRESO,OPORTUNIDAD_CITAS_DE_CONTROL,Codigo_RIPS,Descripcion_RIPS,COSTOS,IPS) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				atencion_medicaStruct atencion_medica_tmp = new atencion_medicaStruct();
// ###############################
...
// # Output table : 'atencion_medica'
								atencion_medica_tmp.FECHA_DE_INGRESO_IPS = (row1.FECHA_DE_INGRESO_IPS.length() == 0)
										? TalendDate.parseDate("dd/MM/yyyy", "01/01/2999")
										: Tratamiento_de_datos.transformacion_fecha(row1.FECHA_DE_INGRESO_IPS);

//TalendDate.parseDate("dd/MM/yyyy", row1.FECHA_DE_INGRESO_IPS ) ;
								atencion_medica_tmp.HORA_DE_INGRESO_IPS = Tratamiento_de_datos
										.transformacion_hora(row1.HORA_DE_INGRESO_IPS);
								atencion_medica_tmp.FECHA_DE__ATENCION_MEDICA = (row1.FECHA_DE__ATENCION_MEDICA
										.length() == 0) ? TalendDate.parseDate("dd/MM/yyyy", "01/01/2999")
												: Tratamiento_de_datos
														.transformacion_fecha(row1.FECHA_DE__ATENCION_MEDICA);
								atencion_medica_tmp.HORA_DE_ATENCION_MEDICA = Tratamiento_de_datos
										.transformacion_hora(row1.HORA_DE_ATENCION_MEDICA);
								atencion_medica_tmp.REQUERIMIENTO_DE_CX = (row1.REQUERIMIENTO_DE_CX.length() == 0)
										? "NO"
										: row1.REQUERIMIENTO_DE_CX;
								atencion_medica_tmp.REFERIDO_A_OTRA_IPS = (row1.REFERIDO_A_OTRA_IPS.length() == 0)
										? "NO"
										: row1.REFERIDO_A_OTRA_IPS;
								atencion_medica_tmp.REGION_ANATOMICA_MAS_AFECTADA = (row1.REGION_ANATOMICA_MAS_AFECTADA
										.length() < 2) ? "SIN INFORMACION" : row1.REGION_ANATOMICA_MAS_AFECTADA;
								atencion_medica_tmp.POLITRAUMATISMO = (row1.POLITRAUMATISMO.length() == 2) ? "NO"
										: row1.POLITRAUMATISMO;
								atencion_medica_tmp.CONDICION_EGRESO = (row1.CONDICION_EGRESO.length() == 0)
										? "SIN INFORMACIÓN"
										: row1.CONDICION_EGRESO;
								atencion_medica_tmp.OPORTUNIDAD_CITAS_DE_CONTROL = (row1.OPORTUNIDAD_CITAS_DE_CONTROL
										.length() == 0) ? "SIN INORMACIÓN" : row1.OPORTUNIDAD_CITAS_DE_CONTROL;
								atencion_medica_tmp.Codigo_RIPS = (row1.Codigo_RIPS.length() == 0) ? "0"
										: row1.Codigo_RIPS;
								atencion_medica_tmp.Descripcion_RIPS = row1.Descripcion_RIPS;
								atencion_medica_tmp.COSTOS = Tratamiento_de_datos.costos(row1.COSTOS);
								atencion_medica_tmp.IPS = row1.IPS;
								atencion_medica = atencion_medica_tmp;
// ###############################
							 ...
							 */
// Start of branch "atencion_medica"
							if (atencion_medica != null) {
								...
								if (atencion_medica.FECHA_DE_INGRESO_IPS != null) {
									pstmt_tDBOutput_1.setTimestamp(1,
											new java.sql.Timestamp(atencion_medica.FECHA_DE_INGRESO_IPS.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.DATE);
								}

								if (atencion_medica.HORA_DE_INGRESO_IPS == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, atencion_medica.HORA_DE_INGRESO_IPS);
								}

								if (atencion_medica.FECHA_DE__ATENCION_MEDICA != null) {
									pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(
											atencion_medica.FECHA_DE__ATENCION_MEDICA.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.DATE);
								}

								if (atencion_medica.HORA_DE_ATENCION_MEDICA == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, atencion_medica.HORA_DE_ATENCION_MEDICA);
								}

								if (atencion_medica.REQUERIMIENTO_DE_CX == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, atencion_medica.REQUERIMIENTO_DE_CX);
								}

								if (atencion_medica.REFERIDO_A_OTRA_IPS == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, atencion_medica.REFERIDO_A_OTRA_IPS);
								}

								if (atencion_medica.REGION_ANATOMICA_MAS_AFECTADA == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, atencion_medica.REGION_ANATOMICA_MAS_AFECTADA);
								}

								if (atencion_medica.POLITRAUMATISMO == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, atencion_medica.POLITRAUMATISMO);
								}

								if (atencion_medica.CONDICION_EGRESO == null) {
									pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(9, atencion_medica.CONDICION_EGRESO);
								}

								if (atencion_medica.OPORTUNIDAD_CITAS_DE_CONTROL == null) {
									pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(10, atencion_medica.OPORTUNIDAD_CITAS_DE_CONTROL);
								}

								if (atencion_medica.Codigo_RIPS == null) {
									pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(11, atencion_medica.Codigo_RIPS);
								}

								if (atencion_medica.Descripcion_RIPS == null) {
									pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(12, atencion_medica.Descripcion_RIPS);
								}

								if (atencion_medica.COSTOS == null) {
									pstmt_tDBOutput_1.setNull(13, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(13, atencion_medica.COSTOS);
								}

								if (atencion_medica.IPS == null) {
									pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(14, atencion_medica.IPS);
								}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "atencion_medica");
				}
	...
	public static void main(String[] args) {
		final dim_atencion_medica dim_atencion_medicaClass = new dim_atencion_medica();

		int exitCode = dim_atencion_medicaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_atencion_medica.class.getClassLoader().getResourceAsStream(
					"costoshospitalaria/dim_atencion_medica_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_atencion_medica.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_atencion_medica");
		}
...
/************************************************************************************************
 * 128227 characters generated by Talend Open Studio for Data Integration on the
 * 27 de junio de 2022, 21:29:28 COT
 ************************************************************************************************/