...
package costoshospitalaria.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbType = "Oracle with service name";
				String user = "costos";
				if (user != null && !"".equals(user)) {
					prop.put("user", user);
				}
				String password = "costos";
				...
				String url = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=localhost)(port=1521))(connect_data=(service_name=)))";
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery(
						"SELECT    COSTOS.DIM_ACCIDENTE.ACCIDENTE_ID,    COSTOS.DIM_ACCIDENTE.RELACION_USUARIO_ACCIDENTE,    COSTOS.DIM_ACCIDENTE.FECHA_DE_ACCIDENTE,    COSTOS.DIM_ACCIDENTE.HORA_DE_ACCIDENTE,    COSTOS.DIM_ACCIDENTE.MES,    COSTOS.DIM_ACCIDENTE.ANO,    COSTOS.DIM_ACCIDENTE.DIA_SEMANA,    COSTOS.DIM_ACCIDENTE.TIPO_DE_VEHICULO FROM COSTOS.DIM_ACCIDENTE");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"costoshospitalaria/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 46915 characters generated by Talend Open Studio for Data Integration on the
 * 28 de junio de 2022, 12:02:44 COT
 ************************************************************************************************/