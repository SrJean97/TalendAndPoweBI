...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_32 = " + \"?\" + \"rewriteBatchedStatements=true\";";
  protected final String TEXT_33 = NL + "        String properties_";
  protected final String TEXT_34 = ";" + NL + "        if (properties_";
  protected final String TEXT_35 = " == null || properties_";
  protected final String TEXT_36 = ".trim().length() == 0) {" + NL + "            properties_";
  protected final String TEXT_37 = " = \"rewriteBatchedStatements=true";
  protected final String TEXT_38 = "&allowLoadLocalInfile=true";
  protected final String TEXT_39 = "\";" + NL + "        }else {" + NL + "            if (!properties_";
  protected final String TEXT_40 = ".contains(\"rewriteBatchedStatements=\")) {" + NL + "                properties_";
  protected final String TEXT_41 = " += \"&rewriteBatchedStatements=true\";" + NL + "            }" + NL;
  protected final String TEXT_42 = NL + "            if (!properties_";
  protected final String TEXT_43 = ".contains(\"allowLoadLocalInfile=\")) {" + NL + "                properties_";
  protected final String TEXT_44 = " += \"&allowLoadLocalInfile=true\";" + NL + "            }";
  protected final String TEXT_45 = NL + "        }" + NL + "" + NL + "        String url_";
  protected final String TEXT_46 = " + \"?\" + properties_";
  ...
  protected final String TEXT_77 = NL + "                log.error(message_";
  protected final String TEXT_78 = NL + "                System.err.println(message_";
  ...
  protected final String TEXT_116 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tboolean inOSGi = routines.system.BundleUtils.inOSGi();" + NL + "\tif (!(inOSGi && dataSources_";
  protected final String TEXT_117 = " != null && ";
  protected final String TEXT_118 = ".replaceAll(\"\\\\s+\",\"\").length() > 0)) {";
  protected final String TEXT_119 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_120 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_121 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_122 = ".get(dsAlias_";
  protected final String TEXT_123 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_124 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_125 = " = dataSources_";
  protected final String TEXT_126 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_127 = ");" + NL + "\t}";
  protected final String TEXT_128 = NL + "\tif (null != conn_";
