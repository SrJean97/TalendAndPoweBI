...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_70 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_71 = " = 0; x_";
  protected final String TEXT_72 = " < dynamic_";
  protected final String TEXT_73 = ".getColumnCount(); x_";
  protected final String TEXT_74 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_75 = " = dynamic_";
  protected final String TEXT_76 = ".getColumnMetadata(x_";
  protected final String TEXT_77 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_78 = ".setName(column_";
  protected final String TEXT_79 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_80 = ".execute(((\"";
  protected final String TEXT_81 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_89 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_90 = ";" + NL + "                    if (";
  protected final String TEXT_91 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_92 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_93 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_94 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_95 = NL;
  protected final String TEXT_96 = NL + "                    String keyCheckTable_";
  protected final String TEXT_97 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_98 = "+\"][\"+";
  protected final String TEXT_99 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_100 = " + \"]\";";
  protected final String TEXT_101 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_102 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_103 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_104 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_105 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_106 = ")== null){//}";
  protected final String TEXT_107 = NL + "                                boolean whetherExist_";
  protected final String TEXT_108 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_109 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_110 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_111 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_112 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_113 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                        whetherExist_";
  protected final String TEXT_114 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_115 = NL + "                                ";
  protected final String TEXT_116 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_117 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_118 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_119 = " = tableNameForSearch_";
  protected final String TEXT_120 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_121 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_122 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_123 = " = dbMetaData_";
  protected final String TEXT_124 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_125 = ", tableNameForSearch_";
  protected final String TEXT_126 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_127 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_128 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_129 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_130 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_131 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_132 = " = rsTable_";
  protected final String TEXT_133 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  ...
  protected final String TEXT_141 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_142 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_143 = "((";
  protected final String TEXT_144 = ") || (dbschema_";
  protected final String TEXT_145 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_146 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_147 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_148 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_149 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_150 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_151 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_152 = " = stmtSchema_";
  protected final String TEXT_153 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_154 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_155 = " = rsSchema_";
  protected final String TEXT_156 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_157 = ".toLowerCase()";
  protected final String TEXT_158 = ") || ((dbschema_";
  protected final String TEXT_159 = " ==null || dbschema_";
  protected final String TEXT_160 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_161 = "(schema_";
  protected final String TEXT_162 = NL + "                                String tableForSearch_";
  protected final String TEXT_163 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_164 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_165 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_166 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_167 = " =  tableForSearch_";
  protected final String TEXT_168 = ".substring(1,tableForSearch_";
  protected final String TEXT_169 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_170 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_171 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_172 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_173 = ".getTables(null, conn_";
  protected final String TEXT_174 = ".getSchema(), tableForSearch_";
  protected final String TEXT_175 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_176 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_177 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_178 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_179 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_180 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_181 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_182 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_183 = ".getMetaData();";
  protected final String TEXT_184 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_185 = ".getTables(";
  protected final String TEXT_186 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_187 = ".getTables(conn_";
  protected final String TEXT_188 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_189 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_190 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_191 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_192 = ".equalsIgnoreCase(";
  protected final String TEXT_193 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_194 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_195 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  ...
  protected final String TEXT_199 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_200 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_201 = ") {" + NL + "\t\t\t\t\t\t                        for (int x_";
  protected final String TEXT_202 = "++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_203 = ");" + NL + "\t\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_204 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_208 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_209 = NL + "                                                      stmtDrop_";
  protected final String TEXT_210 = NL + "                                        stmtDrop_";
  protected final String TEXT_211 = NL + "                                    }";
  protected final String TEXT_212 = NL + "                                            conn_";
  protected final String TEXT_213 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_214 = NL + "                                                  stmtCreate_";
  protected final String TEXT_215 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_216 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_217 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_218 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_219 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_220 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_221 = NL + "                                    stmtCreate_";
  protected final String TEXT_222 = NL + "                                }";
  protected final String TEXT_223 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_224 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_225 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_226 = NL + "                              stmtClear_";
  protected final String TEXT_227 = NL + "                stmtClear_";
  protected final String TEXT_228 = ".executeUpdate(\"";
  protected final String TEXT_229 = "\");";
  protected final String TEXT_230 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_231 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_232 = NL + "                              stmtTruncCount_";
  protected final String TEXT_233 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_234 = " = stmtTruncCount_";
  protected final String TEXT_235 = ".executeQuery(\"";
  protected final String TEXT_236 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_237 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_238 = " = rsTruncCount_";
  protected final String TEXT_239 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_240 = NL + "                              stmtTrunc_";
  protected final String TEXT_241 = NL + "                conn_";
  protected final String TEXT_242 = NL + "                stmtTrunc_";
  protected final String TEXT_243 = NL + "                    if(!conn_";
  protected final String TEXT_244 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_245 = ".commit();" + NL + "                    }";
  protected final String TEXT_246 = NL + "                deletedCount_";
  protected final String TEXT_247 = " += rsTruncCountNumber_";
  protected final String TEXT_248 = ";" + NL + "            }";
  protected final String TEXT_249 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_250 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_251 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_255 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_256 = NL + "                            String insert_";
  protected final String TEXT_257 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_258 = " + \" (";
  protected final String TEXT_259 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_260 = ",\"";
  protected final String TEXT_261 = "+\") VALUES (";
  protected final String TEXT_262 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_263 = ")+\")\";";
  protected final String TEXT_264 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_265 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_266 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_267 = " = new StringBuffer(insert_";
  protected final String TEXT_268 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_269 = ".insert(insert_";
  protected final String TEXT_270 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_271 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_272 = " =insertStringBuffer_";
  protected final String TEXT_273 = ".toString(); ";
  protected final String TEXT_274 = "    " + NL;
  protected final String TEXT_275 = NL + "                        pstmt_";
  protected final String TEXT_276 = ".prepareStatement(insert_";
  protected final String TEXT_277 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_278 = "\", pstmt_";
  protected final String TEXT_279 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_280 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_281 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_282 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_283 = ");" + NL + "                            resourceMap.put(\"pstmt_";
  protected final String TEXT_284 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_285 = ", pstmt_";
  protected final String TEXT_286 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_287 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_292 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_293 = "+\" WHERE ";
  protected final String TEXT_294 = "\";";
  protected final String TEXT_295 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_296 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_297 = " = new StringBuffer(update_";
  protected final String TEXT_298 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_299 = ".insert(update_";
  protected final String TEXT_300 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_301 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_302 = " =updateStringBuffer_";
  protected final String TEXT_303 = NL + "                    pstmt_";
  protected final String TEXT_304 = ".prepareStatement(update_";
  protected final String TEXT_305 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_306 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_307 = " + \" WHERE ";
  protected final String TEXT_308 = "\");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_309 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_310 = ");" + NL + "                    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_311 = "\", pstmtInsert_";
  protected final String TEXT_312 = NL + "                    pstmtUpdate_";
  protected final String TEXT_313 = ");" + NL + "                    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_314 = "\", pstmtUpdate_";
  protected final String TEXT_315 = NL + "                    String delete_";
  protected final String TEXT_316 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_317 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_318 = " = new StringBuffer(delete_";
  protected final String TEXT_319 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_320 = ".insert(delete_";
  protected final String TEXT_321 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_322 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_323 = " =deleteStringBuffer_";
  protected final String TEXT_324 = ".toString();  ";
  protected final String TEXT_325 = NL + "                    pstmt_";
  protected final String TEXT_326 = ".prepareStatement(delete_";
  protected final String TEXT_327 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_328 = " = insert_";
  protected final String TEXT_329 = ".split(\"\\\\?\");";
  protected final String TEXT_330 = NL + "\t\t\tupdate_";
  protected final String TEXT_331 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_332 = " = update_";
  protected final String TEXT_333 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_334 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_335 = NL + "\t\t\tdelete_";
  protected final String TEXT_336 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_337 = " = delete_";
  protected final String TEXT_338 = NL + "\t\t\treplace_";
  protected final String TEXT_339 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_340 = " = replace_";
  protected final String TEXT_341 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_342 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_343 = " = insertIgnore_";
  protected final String TEXT_344 = NL + "        }";
  protected final String TEXT_345 = NL + "        query_";
  protected final String TEXT_346 = " = new StringBuffer(\"\");";
  protected final String TEXT_347 = NL + "                commitEvery_";
  protected final String TEXT_348 = " = buffersSize_";
  protected final String TEXT_349 = NL + "            batchSize_";
  protected final String TEXT_350 = NL + "        whetherReject_";
  protected final String TEXT_351 = " = false;";
  protected final String TEXT_352 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_353 = NL + "                            // TODO error: ";
  protected final String TEXT_354 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_355 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_356 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_357 = " = tGeometry_";
  protected final String TEXT_358 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_359 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_360 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_361 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_362 = "\", geometry_";
  protected final String TEXT_363 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_364 = ".expandToInclude(geometry_";
  protected final String TEXT_365 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_366 = " = geometry_";
  protected final String TEXT_367 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_368 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_369 = " = oracle_wkt_";
  protected final String TEXT_370 = ".toJGeometry(wkt_";
  protected final String TEXT_371 = ".getBytes());" + NL;
  protected final String TEXT_372 = NL + "                            jgeometry_";
  protected final String TEXT_373 = ".setSRID(";
  protected final String TEXT_374 = ".setObject(";
  protected final String TEXT_375 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  protected final String TEXT_376 = ", conn_";
  protected final String TEXT_377 = NL + "                        query_";
  protected final String TEXT_378 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_379 = ",";
  protected final String TEXT_380 = ", ";
  protected final String TEXT_381 = ",insertSQLSplits_";
  protected final String TEXT_382 = NL + "                \t\tblobTypeUtil_";
  protected final String TEXT_383 = ".adaptBlobFromOtherDB(";
  protected final String TEXT_384 = ",conn_";
  protected final String TEXT_385 = ");" + NL + "                \t";
  protected final String TEXT_386 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_387 = NL + "                globalMap.put(\"";
  protected final String TEXT_388 = "_QUERY\", query_";
  protected final String TEXT_389 = ".toString().trim());";
  protected final String TEXT_390 = NL + "                pstmt_";
  protected final String TEXT_391 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_392 = "++;";
  protected final String TEXT_393 = NL + "                batchSizeCounter_";
  protected final String TEXT_394 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_395 = NL + "                    int processedCount_";
  protected final String TEXT_396 = " = pstmt_";
  protected final String TEXT_397 = ".executeUpdate();" + NL + "                    insertedCount_";
  protected final String TEXT_398 = " += processedCount_";
  protected final String TEXT_399 = ";" + NL + "                    rowsToCommitCount_";
  protected final String TEXT_400 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_401 = ") {" + NL + "globalMap.put(\"";
  protected final String TEXT_402 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_403 = ".getMessage());" + NL + "                    whetherReject_";
  protected final String TEXT_404 = " = true;";
  protected final String TEXT_405 = NL + "                        throw(e_";
  protected final String TEXT_406 = " = new ";
  protected final String TEXT_407 = "Struct();";
  protected final String TEXT_408 = NL + "                                ";
  protected final String TEXT_409 = NL + "                            rejectedCount_";
  protected final String TEXT_410 = " = rejectedCount_";
  protected final String TEXT_411 = " + 1;";
  protected final String TEXT_412 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_413 = ").getSQLState();";
  protected final String TEXT_414 = ".errorMessage = e_";
  protected final String TEXT_415 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_416 = NL + "                            System.err.print(e_";
  protected final String TEXT_417 = ".getMessage());";
  protected final String TEXT_418 = NL + "                }";
  protected final String TEXT_419 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_420 = ",updateSQLSplits_";
  protected final String TEXT_421 = NL + "                    int count_";
  protected final String TEXT_422 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_423 = NL + "                           ";
  protected final String TEXT_424 = NL + "                                query_";
  protected final String TEXT_425 = NL + "                            query_";
  protected final String TEXT_426 = NL + "                           query_";
  protected final String TEXT_427 = ".executeUpdate();" + NL + "                    updatedCount_";
  protected final String TEXT_428 = NL + "            int checkCount_";
  protected final String TEXT_429 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_430 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_431 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_432 = " = rs_";
  protected final String TEXT_433 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_434 = " > 0) {";
  protected final String TEXT_435 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_436 = NL + "\t                \t\tblobTypeUtil_";
  protected final String TEXT_437 = ");" + NL + "\t                \t";
  protected final String TEXT_438 = NL + "                        int count_";
  protected final String TEXT_439 = ", pstmtUpdate_";
  protected final String TEXT_440 = NL + "                                    query_";
  protected final String TEXT_441 = NL + "                    globalMap.put(\"";
  protected final String TEXT_442 = NL + "                try {";
  protected final String TEXT_443 = " = pstmtUpdate_";
  protected final String TEXT_444 = ";" + NL + "                    nb_line_";
  protected final String TEXT_445 = NL + "                        nb_line_";
  protected final String TEXT_446 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_447 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_448 = ", pstmtInsert_";
  protected final String TEXT_449 = " = pstmtInsert_";
  protected final String TEXT_450 = NL + "                }" + NL + "            }";
  protected final String TEXT_451 = NL + "            int updateFlag_";
  protected final String TEXT_452 = " = 0;";
  protected final String TEXT_453 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_454 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_455 = " = updatedCount_";
  protected final String TEXT_456 = "+updateFlag_";
  protected final String TEXT_457 = ";" + NL + "                rowsToCommitCount_";
  protected final String TEXT_458 = " += updateFlag_";
  protected final String TEXT_459 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_460 = " == 0) {";
  protected final String TEXT_461 = NL + "                                routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_462 = NL + "\t\t                \t\tblobTypeUtil_";
  protected final String TEXT_463 = ");" + NL + "\t\t                \t";
  protected final String TEXT_464 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_465 = NL + "                        globalMap.put(\"";
  protected final String TEXT_466 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_467 = NL + "                }" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_468 = ".getMessage());" + NL + "                whetherReject_";
  protected final String TEXT_469 = NL + "                    throw(e_";
  protected final String TEXT_470 = NL + "                    nb_line_";
  protected final String TEXT_471 = NL + "                        rejectedCount_";
  protected final String TEXT_472 = NL + "                        System.err.print(e_";
  protected final String TEXT_473 = NL + "            }";
  protected final String TEXT_474 = ".executeUpdate();" + NL + "                    deletedCount_";
  ...
  protected final String TEXT_480 = ") {" + NL + "                try {";
  protected final String TEXT_481 = ".executeBatch();";
  protected final String TEXT_482 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_483 = "){" + NL + "globalMap.put(\"";
  protected final String TEXT_484 = ".getMessage());" + NL + "\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_485 = " = e_";
  protected final String TEXT_486 = ".getNextException(),sqle_";
  protected final String TEXT_487 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_488 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_489 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_490 = " = new java.sql.SQLException(e_";
  protected final String TEXT_491 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_492 = ".getMessage(), ne_";
  protected final String TEXT_493 = ".getSQLState(), ne_";
  protected final String TEXT_494 = ".getErrorCode(), ne_";
  protected final String TEXT_495 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_496 = " = sqle_";
  ...
  protected final String TEXT_506 = ".getUpdateCount();";
  protected final String TEXT_507 = NL + "                    insertedCount_";
  protected final String TEXT_508 = NL + "                    updatedCount_";
  protected final String TEXT_509 = NL + "                    deletedCount_";
  protected final String TEXT_510 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_511 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_512 = ":0);" + NL + "                rowsToCommitCount_";
  protected final String TEXT_513 = " += (tmp_batchUpdateCount_";
  protected final String TEXT_514 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_515 = " = 0;" + NL + "            }";
  protected final String TEXT_516 = NL + "                commitCounter_";
  protected final String TEXT_517 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_518 = " <= commitCounter_";
  protected final String TEXT_519 = NL + "                    if(batchSizeCounter_";
  protected final String TEXT_520 = " > 0) {" + NL + "                        try {";
  protected final String TEXT_521 = NL + "                            pstmt_";
  protected final String TEXT_522 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_523 = ".getMessage());" + NL + "\t\t\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_524 = "=null;" + NL + "\t\t\t\t\t    \tString errormessage_";
  protected final String TEXT_525 = ";" + NL + "\t\t\t\t\t\t\tif (ne_";
  protected final String TEXT_526 = " != null) {" + NL + "\t\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_527 = ");" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_528 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_529 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t            \t";
  protected final String TEXT_530 = NL + "\t\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_531 = " != null) {" + NL + "\t\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_532 = ");" + NL + "\t\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t\t            \tthrow(e_";
  protected final String TEXT_533 = ");" + NL + "\t\t\t\t\t            }" + NL + "\t\t\t            \t";
  protected final String TEXT_534 = NL + "\t\t\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_535 = ");" + NL + "\t\t\t            \t";
  protected final String TEXT_536 = NL + "\t\t\t        \t}" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_537 = NL + "                            insertedCount_";
  protected final String TEXT_538 = NL + "                            updatedCount_";
  protected final String TEXT_539 = NL + "                            deletedCount_";
  protected final String TEXT_540 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_541 = ":0);" + NL + "                        rowsToCommitCount_";
  protected final String TEXT_542 = ":0);" + NL + "                    }";
  protected final String TEXT_543 = NL + "                    if(rowsToCommitCount_";
  protected final String TEXT_544 = " != 0){" + NL + "                    \t";
  protected final String TEXT_545 = NL + "                    }" + NL + "                    conn_";
  protected final String TEXT_546 = ".commit();" + NL + "                    if(rowsToCommitCount_";
  protected final String TEXT_547 = NL + "                    \trowsToCommitCount_";
  protected final String TEXT_548 = " = 0;" + NL + "                    }" + NL + "                    commitCounter_";
  protected final String TEXT_549 = "=0;";
  protected final String TEXT_550 = NL + "                    \tbatchSizeCounter_";
