...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_167 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_168 = "));";
  protected final String TEXT_169 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_170 = ";" + NL + "\t                    if (";
  protected final String TEXT_171 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_172 = " = 0; x_";
  protected final String TEXT_173 = " < dynamic_";
  protected final String TEXT_174 = ".getColumnCount(); x_";
  protected final String TEXT_175 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_176 = " = dynamic_";
  protected final String TEXT_177 = ".getColumnMetadata(x_";
  protected final String TEXT_178 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_179 = ".setName(column_";
  protected final String TEXT_180 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_181 = ".execute(((\"";
  protected final String TEXT_182 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_192 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_193 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_194 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_195 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_246 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_247 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_248 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_249 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_250 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_251 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_258 = ".toLowerCase()";
  protected final String TEXT_259 = ") || ((dbschema_";
  protected final String TEXT_260 = " ==null || dbschema_";
  protected final String TEXT_261 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_262 = "(schema_";
  protected final String TEXT_263 = NL + "                                String tableForSearch_";
  protected final String TEXT_264 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_265 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_266 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_267 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_268 = " =  tableForSearch_";
  protected final String TEXT_269 = ".substring(1,tableForSearch_";
  protected final String TEXT_270 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  ...
  protected final String TEXT_274 = ".getTables(null, conn_";
  protected final String TEXT_275 = ".getSchema(), tableForSearch_";
  protected final String TEXT_276 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_277 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_278 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_279 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_280 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_281 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_282 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_283 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_284 = ".getMetaData();";
  protected final String TEXT_285 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_286 = ".getTables(";
  protected final String TEXT_287 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_288 = ".getTables(conn_";
  protected final String TEXT_289 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_290 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_291 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_292 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_293 = ".equalsIgnoreCase(";
  protected final String TEXT_294 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_295 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_296 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_297 = NL + "                                if(!whetherExist_";
  protected final String TEXT_298 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_299 = NL + "                                                      stmtCreate_";
  protected final String TEXT_300 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_301 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_302 = ") {" + NL + "\t\t\t\t\t\t                        for (int x_";
  protected final String TEXT_303 = "++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_304 = ");" + NL + "\t\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_305 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_309 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_316 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_317 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_318 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_319 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_320 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_321 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_322 = NL + "                                    stmtCreate_";
  protected final String TEXT_323 = NL + "                                }";
  protected final String TEXT_324 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_325 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_326 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_331 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_332 = NL + "                              stmtTruncCount_";
  protected final String TEXT_333 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_334 = " = stmtTruncCount_";
  protected final String TEXT_335 = ".executeQuery(\"";
  protected final String TEXT_336 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_337 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_338 = " = rsTruncCount_";
  protected final String TEXT_339 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_343 = NL + "                    if(!conn_";
  protected final String TEXT_344 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_345 = ".commit();" + NL + "                    }";
  protected final String TEXT_346 = NL + "                deletedCount_";
  protected final String TEXT_347 = " += rsTruncCountNumber_";
  protected final String TEXT_348 = ";" + NL + "            }";
  protected final String TEXT_349 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_350 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_351 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_355 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_356 = NL + "                String insert_";
  protected final String TEXT_357 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_358 = " + \" (";
  protected final String TEXT_359 = ") VALUES (";
  protected final String TEXT_360 = ")\";";
  protected final String TEXT_361 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_362 = " = new StringBuffer(insert_";
  protected final String TEXT_363 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_364 = ".insert(insert_";
  protected final String TEXT_365 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_366 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_367 = " =insertStringBuffer_";
  protected final String TEXT_368 = ".toString(); ";
  protected final String TEXT_369 = "    " + NL;
  protected final String TEXT_370 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_371 = ".prepareStatement(insert_";
  protected final String TEXT_372 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_393 = ".prepareStatement(update_";
  protected final String TEXT_394 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_395 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_399 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_400 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_401 = "\", pstmtInsert_";
  protected final String TEXT_402 = ");" + NL + "                String update_";
  protected final String TEXT_403 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_404 = ");" + NL + "                resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_405 = "\", pstmtUpdate_";
  protected final String TEXT_406 = NL + "                String delete_";
  protected final String TEXT_407 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_408 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_409 = " = new StringBuffer(delete_";
  protected final String TEXT_410 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_411 = ".insert(delete_";
  protected final String TEXT_412 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_413 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_414 = " =deleteStringBuffer_";
  protected final String TEXT_415 = ".toString();  ";
  protected final String TEXT_416 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_417 = ".prepareStatement(delete_";
  protected final String TEXT_418 = NL + "                StringBuffer query_";
  protected final String TEXT_419 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_420 = " = insert_";
  protected final String TEXT_421 = ".split(\"\\\\?\");";
  protected final String TEXT_422 = NL + "\t\t\tupdate_";
  protected final String TEXT_423 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_424 = " = update_";
  protected final String TEXT_425 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_426 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_427 = NL + "\t\t\tdelete_";
  protected final String TEXT_428 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_429 = " = delete_";
  protected final String TEXT_430 = NL + "\t\t\treplace_";
  protected final String TEXT_431 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_432 = " = replace_";
  protected final String TEXT_433 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_434 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_435 = " = insertIgnore_";
  protected final String TEXT_436 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_437 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_438 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_439 = " = true;";
  protected final String TEXT_440 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_441 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){" + NL + "globalMap.put(\"";
  protected final String TEXT_442 = "_ERROR_MESSAGE\",sqlexp.getMessage());";
  protected final String TEXT_443 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){" + NL + "globalMap.put(\"";
  protected final String TEXT_444 = "_ERROR_MESSAGE\",exp.getMessage());";
  protected final String TEXT_445 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_446 = " clobTypeUtil_";
  protected final String TEXT_447 = "=new ClobTypeUtil_";
  protected final String TEXT_448 = "();";
  protected final String TEXT_449 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_450 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "            \tboolean containBlobFromOtherDB = ";
  ...
  protected final String TEXT_452 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_453 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){" + NL + "globalMap.put(\"";
  protected final String TEXT_454 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_455 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_456 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_457 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_458 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }";
  protected final String TEXT_459 = NL + "\t\t\tpublic void adaptBlobFromOtherDB(routines.system.Dynamic dynamicColumnValue, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                int size = dynamicColumnValue.getColumnCount();" + NL + "               \tfor(int index = 0; index < size; index++){" + NL + "                \tObject value = dynamicColumnValue.getColumnValue(index);" + NL + "                \tif(value instanceof java.sql.Blob || (value instanceof oracle.sql.BLOB)) {" + NL + "                \t\t dynamicColumnValue.setColumnValue(index, getBLOB(value, conn));" + NL + "\t                }" + NL + "                }" + NL + "            }";
  protected final String TEXT_460 = NL + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_461 = " blobTypeUtil_";
  protected final String TEXT_462 = "=new BlobTypeUtil_";
  protected final String TEXT_463 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_464 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_465 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_471 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_472 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_473 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_474 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_475 = NL + NL + NL + NL;
